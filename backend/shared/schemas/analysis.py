...
"""
    ...
    niche: str = Field(
        ...
        description=
            "O nicho de mercado do negócio ou produto a ser analisado."
    )
    description: str = Field(
        ...,
        min_length=100,
        title="Descrição Detalhada",
        description="Descrição detalhada do negócio ou produto, \
            com no mínimo 100 caracteres para garantir uma análise de qualidade."
    )
