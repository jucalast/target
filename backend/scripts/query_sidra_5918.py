...
def query_sidra_example():
    ...
    try:
        ...
        print("Este exemplo consulta a tabela do IPCA (1419) sem classificações.")
        print("Para ver um exemplo com classificações, descomente o código no script.")
        print("Para consultar a tabela 5918, você precisará obter os códigos corretos de classificação.")
        ...
        print(f"\nConsultando tabela {table_code} (IPCA) com os seguintes parâmetros:")
